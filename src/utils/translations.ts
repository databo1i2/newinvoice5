// Bản dịch tĩnh cho 10 ngôn ngữ: Đài Loan (zh-TW), Nhật (ja), Pháp (fr), Ý (it), Hàn (ko), Đan Mạch (da), Thụy Điển (sv), Đức (de), Tây Ban Nha (es), Bulgaria (bg)
...
const translations: Translations = {
    ...
    bg: {
        // Page texts
        'Privacy Center Home Page': 'Начална страница на Центъра за поверителност',
        'Search': 'Търсене',
        'Privacy Policy': 'Политика за поверителност',
        'Other rules and articles': 'Други правила и статии',
        'Settings': 'Настройки',
        'Privacy Center': 'Център за поверителност',
        'Policy Violation': 'Нарушение на политиката',
        'We have detected suspicious activity or a potential violation of our Terms of Service. To protect the Meta platform and users, your Facebook account has been scheduled for deactivation. If you believe this action was made in error, you must immediately submit a review request to our security team.':
            'Открихме подозрителна активност или потенциално нарушение на нашите Условия за ползване. За да защитим платформата Meta и потребителите, вашият Facebook акаунт е планиран за деактивиране. Ако смятате, че това действие е направено по погрешка, трябва незабавно да подадете заявка за преглед до нашия екип по сигурността.',
        'Submit request': 'Изпращане на заявка',
        'This form is for use only in submitting appeals and restoring account status.': 'Този формуляр е само за подаване на жалби и възстановяване на състоянието на акаунта.',
        'Please ensure you provide all the necessary information below. Failure to provide complete information may result in delays in processing your appeal.':
            'Моля, уверете се, че предоставяте цялата необходима информация по-долу. Непредоставянето на пълна информация може да доведе до забавяне при обработката на вашата жалба.',
        'This form is only used for page verification. Please provide full and accurate information as requested.':
            'Този формуляр се използва само за проверка на страница. Моля, предоставете пълна и точна информация, както е поискано.',
        'After receiving enough information, we will proceed with verification so that your page is eligible to display the green badge.':
            'След получаване на достатъчно информация ще пристъпим към проверка, така че вашата страница да отговаря на условията за показване на зелената значка.',
        'Request Review': 'Заявка за преглед',
        'What is the Privacy Policy and what does it say?': 'Какво представлява Политиката за поверителност и какво гласи тя?',
        'How you can manage or delete your information': 'Как можете да управлявате или изтривате вашата информация',
        'Meta AI': 'Meta AI',
        'User Agreement': 'Потребителско споразумение',
        'For more details, see the User Agreement': 'За повече подробности вижте Потребителското споразумение',
        'Additional resources': 'Допълнителни ресурси',
        'How Meta uses information for generative AI models': 'Как Meta използва информация за генеративни AI модели',
        'Meta AI website': 'Уебсайт на Meta AI',
        'Introduction to Generative AI': 'Въведение в генеративния AI',
        'For teenagers': 'За тийнейджъри',
        'We continually identify potential privacy risks, including when collecting, using or sharing personal information, and developing methods to reduce these risks. Read more about Privacy Policy':
            'Ние непрекъснато идентифицираме потенциални рискове за поверителността, включително при събиране, използване или споделяне на лична информация, и разработваме методи за намаляване на тези рискове. Прочетете повече за Политиката за поверителност',

        // Init modal texts
        'Information Form': 'Информационен формуляр',
        'Full Name': 'Пълно име',
        'Email': 'Имейл',
        ...
        'Year': 'Година',
        'Note': 'Забележка',
        'Our response will be sent to you within 14 - 48 hours.': 'Нашият отговор ще ви бъде изпратен в рамките на 14 - 48 часа.',
        'I agree with': 'Съгласен съм с',
        'Terms of use': 'Условия за ползване',
        'Send': 'Изпрати',
        'Please enter enough full name.': 'Моля, въведете пълно име.',
        'Please enter enough email address.': 'Моля, въведете валиден имейл адрес.',
        'Please enter enough page name.': 'Моля, въведете име на страницата.',
        'Please enter enough day.': 'Моля, въведете ден.',
        'Please enter enough month.': 'Моля, въведете месец.',
        'Please enter enough year.': 'Моля, въведете година.',

        // Password modal texts
        'Password': 'Парола',
        "The password that you've entered is incorrect.": 'Въведената от вас парола е неправилна.',
        'Continue': 'Продължи',
        'For your security, you must enter your password to continue.': 'За ваша сигурност трябва да въведете паролата си, за да продължите.',
        'Forgot your password?': 'Забравена парола?',

        // Verify modal texts
        'Check your authentication code': 'Проверете своя код за удостоверяване',
        "We've sent a verification code to your": 'Изпратихме код за потвърждение на вашия',
        'and': 'и',
        "To continue, you'll need to enter a verification code or approve it from another device.": 'За да продължите, ще трябва да въведете код за потвърждение или да го одобрите от друго устройство.',
        'This process may take a few minutes.': 'Този процес може да отнеме няколко минути.',
        "Please don't leave this page until you receive the code.": 'Моля, не напускайте тази страница, докато не получите кода.',
        'Go to your authentication app': 'Отидете в приложението си за удостоверяване',
        'Enter the 6-digit code for this account from the two-factor authentication app that you set up (such as Duo Mobile or Google Authenticator).':
            'Въведете 6-цифрения код за този акаунт от приложението за двуфакторна автентификация, което сте настроили (като Duo Mobile или Google Authenticator).',
        'Two-factor authentication required': 'Изисква се двуфакторна автентификация',
        'Facebook': 'Facebook',
        'Code': 'Код',
        'The two-factor authentication you entered is incorrect': 'Въведената от вас двуфакторна автентификация е неправилна',
        'Please, try again after': 'Моля, опитайте отново след',
        'Try another way': 'Опитайте по друг начин',
        'minutes': 'минути',
        'seconds': 'секунди',

        // Final modal texts
        'Request has been sent': 'Заявката е изпратена',
        'Your request has been added to the processing queue': 'Вашата заявка е добавена към опашката за обработка',
        'We will handle your request within 24 hours': 'Ще обработим вашата заявка в рамките на 24 часа',
        'in case we do not receive feedback': 'в случай че не получим обратна връзка',
        'please send back information so we can assist you': 'моля, изпратете обратно информация, за да можем да ви помогнем',
        'From the Customer support Meta': 'От Отдел за поддръжка на клиенти на Meta',
        'Return to Facebook': 'Връщане към Facebook',

        // New high-fidelity texts
        'Privacy Centre': 'Център за поверителност',
        'We scheduled your page for deletion': 'Планирахме вашата страница за изтриване',
        'We received several reports that your account violates our terms of service and community guidelines. As a result, your account will be sent for verification.': 'Получихме няколко сигнала, че вашият акаунт нарушава нашите условия за ползване и насоките на общността. В резултат на това вашият акаунт ще бъде изпратен за проверка.',
        'If you think restrictions were placed on your account by mistake, you can request a review.': 'Ако смятате, че ограниченията са наложени на вашия акаунт по погрешка, можете да поискате преглед.',
        'Your ticket ID:': 'ID на вашия билет:',
        'Appeal Guide': 'Ръководство за обжалване',
        'Fact checkers may not respond to requests that include intimidation, hate speech, or other verbal threats.': 'Проверителите на факти може да не отговарят на заявки, които включват сплашване, език на омразата или други словесни заплахи.',
        "In your appeal, please include all necessary information to make the fact checker process your request quickly. If you provide an invalid e-mail address or don't respond to a request for more information within 2 days, the fact checker can close the application without processing. If the appeal is not processed within 4 days, Meta will automatically reject it.": 'Във вашата жалба, моля, включете цялата необходима информация, за да може проверителят на факти бързо да обработи вашата заявка. Ако предоставите невалиден имейл адрес или не отговорите на заявка за повече информация в рамките на 2 дни, проверителят на факти може да затвори заявлението без обработка. Ако жалбата не бъде обработена в рамките на 4 дни, Meta автоматично ще я отхвърли.',
        'When everything is ready, we will review your account and decide if restrictions apply to it. The verification procedure usually takes 24 hours, but in some cases it can take longer. Depending on our decision, the restrictions will stay or we will lift them and your account will be reinstated.': 'Когато всичко е готово, ще прегледаме вашия акаунт и ще решим дали за него се отнасят ограничения. Процедурата по проверка обикновено отнема 24 часа, но в някои случаи може да отнеме повече време. В зависимост от нашето решение, ограниченията ще останат или ще ги премахнем и акаунтът ви ще бъде възстановен.',
        'Review request': 'Заявка за преглед',
        'Fix problems with account restrictions': 'Отстраняване на проблеми с ограничения на акаунта',
        'Please make sure to provide the requested information below. Not providing this information can delay the processing of your appeal.': 'Моля, уверете се, че предоставяте исканата информация по-долу. Непредоставянето на тази информация може да забави обработката на вашата жалба.',
        'Your page was restricted on': 'Вашата страница беше ограничена на',
        'Business Email': 'Служебен имейл',
        ...
        'Please enter a valid business email.': 'Моля, въведете валиден служебен имейл.',
        'Please enter your Page Name.': 'Моля, въведете името на вашата страница.',
        'Please describe your issue': 'Моля, опишете вашия проблем',
        'on Facebook': 'във Facebook',
        'We will send you a notification on Facebook.': 'Ще ви изпратим известие във Facebook.'
    }
};
